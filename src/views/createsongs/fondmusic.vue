...
import { getsongdetail, getplaylisttrack } from "../../network/detail";
...
export default {
  ...
  methods: {
    ...
    getplaylisttrack({ id: this.itemlist.id }).then((res) => {
